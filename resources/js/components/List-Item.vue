        ...
        <div class="px-4 py-4 sm:px-6">
            ...
            <div class="mt-2 sm:flex sm:justify-between">
                ...
                <div class="mt-2 flex items-center text-sm leading-5 text-gray-500 sm:mt-0">
                    ...
                    <span>
                Created At
                <time datetime="2020-01-07">{{ project.created_at }}</time>
              </span>
                </div>
            </div>
        </div>
...
export default {
    ...
    data() {
        return {
            soundUrl: 'http://laravel-realtime.test/notification.mp3'
        }
    },
    methods: {
        editProject(project) {
    ...
    mounted() {
        Echo.private(`project.${this.project.id}`)
            .listen('ProjectStatusUpdated', (e) => {
                console.log(e);
                this.project.status= e.project.status
                this.playSound()
            });
    },
}
